...
var innerNav = document.getElementsByClassName("thesis-links");

function rememberNav() {
  var bigState = sessionStorage.getItem('navState');
...
var underTablet = window.matchMedia("(max-width: 769px)");
...
function openNav(object) {
  if (underTablet.matches) {
    var helper = object.offsetHeight;
    var margin = "-" + helper + "px";
    var slideDown = new KeyframeEffect(object, [{
      marginTop: margin
    }, {
      marginTop: "0px"
    }], {
...
function closeNav(object) {
  if (underTablet.matches) {
    var helper = object.offsetHeight;
    var margin = "-" + helper + "px";
    var slideUp = new KeyframeEffect(object, [{
      marginTop: "0px"
    }, {
      marginTop: margin
    }], {
...
var backBtn = document.getElementsByClassName("getUrl");
var lastPage = document.referrer;

function bibliography() {
  Array.prototype.forEach.call(backBtn, function (i) {
...
//# sourceMappingURL=template/main.d8ebb8d6.js.map